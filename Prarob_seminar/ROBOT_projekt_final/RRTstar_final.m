...
niz_spoji = evalin('base', 'niz_spoji');
niz_zaobidi = evalin('base', 'niz_zaobidi');
...
t = evalin('base', 't');
height=size(img,1);
world_complete_path1=world_path_calculator(complete_path,cameraParams,T_world_camera,height)%nedostaje T_world_camera
...
assignin('base', 'world_complete_path1', world_complete_path1);
assignin('base', 'world_complete_path2', world_complete_path2);
